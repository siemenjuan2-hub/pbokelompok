...
public class CollisonChecker {
    ...
    public void checkTile(Entity entity) {
        ...
        int entityRightWorldX = entity.WorldX +
                entity.solidArea.x +
        ...
        int entityBottomWorldY = entity.WorldY +
                entity.solidArea.y +
        ...
        switch (entity.direction) {
            ...
            case "down":
                entityBottomRow = (entityBottomWorldY + entity.getSpeed())
                        / gp.tileSize;
                break;

            case "left":
                entityLeftCol = (entityLeftWorldX - entity.getSpeed())
                        / gp.tileSize;
                break;

            case "right":
                entityRightCol = (entityRightWorldX + entity.getSpeed())
                        / gp.tileSize;
                break;
        }
        ...
        int tileNum2 = gp.tileM.mapTileNum[gp.currentMap][entityRightCol][entityBottomRow];
