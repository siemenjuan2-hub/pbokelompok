...
public class MON_QueenSlime extends Entity {
    ...
    public MON_QueenSlime(GamePanel gp) {
        super(gp);
        type = type_monster;
        entitySize = 256;
        name = "Queen Slime";
    ...
    public void getImage() {
        up1 = setUp("/assets/Monster/QueenSlime/Queenslime_down_1", gp.tileSize, gp.tileSize);
        up2 = setUp("/assets/Monster/QueenSlime/Queenslime_down_2", gp.tileSize, gp.tileSize);
        down1 = setUp("/assets/Monster/QueenSlime/Queenslime_down_1", gp.tileSize, gp.tileSize);
        down2 = setUp("/assets/Monster/QueenSlime/Queenslime_down_2", gp.tileSize, gp.tileSize);
        left1 = setUp("/assets/Monster/QueenSlime/Queenslime_down_1", gp.tileSize, gp.tileSize);
        left2 = setUp("/assets/Monster/QueenSlime/Queenslime_down_2", gp.tileSize, gp.tileSize);
        right1 = setUp("/assets/Monster/QueenSlime/Queenslime_down_1", gp.tileSize, gp.tileSize);
        right2 = setUp("/assets/Monster/QueenSlime/Queenslime_down_2", gp.tileSize, gp.tileSize);
    }
